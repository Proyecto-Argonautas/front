...
import logoAG from "~/assets/logoAG_1.svg";
    ...
    <>
      <div className="absolute top-0 left-0 right-0 flex justify-between items-center p-4 z-50">
        ...
        >
          ...
          <img src={logoAG} alt="Logo Argonautas" className="w-full h-full object-contain relative z-10 filter brightness-0 invert" />
        </Link>
          ...
          <div className="fixed top-20 right-4 bg-white rounded-lg shadow-lg border border-gray-200 w-72 z-50 overflow-hidden">
            ...
            <div className="p-4 border-b border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">albgonzalez98@gmail.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50">
              <div className="flex justify-center space-x-4 text-xs text-gray-500">
                ...
                <span>•</span>
                <a href="#" className="hover:text-gray-700">Términos del Servicio</a>
              </div>
            </div>
          </div>
        </>
