import { ChevronDown, ChevronUp, PlaneTakeoff } from "lucide-react";
...
export default function FlightArticle() {
  ...
  return (
    <article className="w-full max-w-md mx-auto mb-5 mt-5 bg-white rounded-2xl shadow-md">
      <button
        type="button"
      ...
      >
        <h2 className=" flex gap-5 text-lg font-semibold text-left">Flights <PlaneTakeoff /></h2>
