		...
		<article className="relative w-full mt-5 bg-white rounded-2xl shadow-md">
			...
			>
				<div className="flex items-center gap-2 mr-auto">
					<DollarSign />
					<h2 className="flex gap-2 text-lg font-semibold min-w-10">Currency</h2>
			...
			{open && (
				<div className="border-t px-4 py-4 space-y-3 text-sm text-gray-700">
					...
					<div className="flex justify-between">
						<div>
							<div className="text-xs text-gray-500">1 {fromCurrency} equivale a</div>
							<div className="font-semibold text-lg">
								{isLoading ? "..." : exchangeRate ? exchangeRate.toFixed(4) : "Error"} {symbols[toCurrency]?.description || toCurrency}
							</div>
						</div>
					</div>
